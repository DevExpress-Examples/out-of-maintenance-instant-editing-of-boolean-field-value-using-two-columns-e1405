<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="BooleanRepresentation._Default" %>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="In production" FieldName="InProduction"
                    VisibleIndex="4">
                    <DataItemTemplate>
                        <dxe:aspxradiobutton id="btnInProduction" runat="server" checked='<%# !(bool)Eval("Discontinued") %>'
